...
new Position { Title = "公關經理" },
new Position { Title = "遊戲美術設計師" },
new Position { Title = "資料科學家" },
new Position { Title = "資安工程師" },
new Position { Title = "雲端架構師" },
new Position { Title = "遊戲程式設計師" },
new Position { Title = "前端工程師" },
new Position { Title = "後端工程師" },
new Position { Title = "DevOps工程師" },
new Position { Title = "機器學習工程師" },
new Position { Title = "網路工程師" },
new Position { Title = "都市農夫" },
new Position { Title = "環保顧問" },
new Position { Title = "太陽能工程師" },
new Position { Title = "生態導覽員" },
new Position { Title = "農產品行銷經理" },
new Position { Title = "環境教育講師" },
new Position { Title = "海洋保育員" },
new Position { Title = "都市農業規劃師" },
new Position { Title = "生物多樣性研究員" },
new Position { Title = "森林志工" },
new Position { Title = "文物修復師" },
new Position { Title = "劇場行政人員" },
new Position { Title = "藝廊策展人" },
new Position { Title = "博物館導覽員" },
new Position { Title = "文創商品開發" },
new Position { Title = "電影製片人" },
new Position { Title = "音樂經紀人" },
new Position { Title = "畫廊藝術家" },
new Position { Title = "文化資產保存員" },
new Position { Title = "藝術行政人員" },
new Position { Title = "甜點學徒" },
new Position { Title = "咖啡烘豆師" },
new Position { Title = "私廚主廚" },
new Position { Title = "侍酒師" },
new Position { Title = "餐飲管理師" },
new Position { Title = "調酒師" },
new Position { Title = "烘焙坊師傅" },
new Position { Title = "中餐主廚" },
new Position { Title = "冰品設計師" },
new Position { Title = "廚藝講師" },
new Position { Title = "導遊" },
new Position { Title = "社群行銷經理" },
new Position { Title = "室內設計師" },
new Position { Title = "課程設計師" },
new Position { Title = "風險管理師" },
new Position { Title = "水產養殖技師" },
new Position { Title = "機械維修工程師" },
new Position { Title = "都市規劃師" },
new Position { Title = "造型設計師" },
new Position { Title = "國際貨運專員" });

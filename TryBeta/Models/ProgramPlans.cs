...
namespace TryBeta.Models
{
    public class ProgramPlans
    {
        ...
        public int ProgramCount { get; set; } // 這次體驗人數
        ...
        public DateTime ProgramStartDate { get; set; }  //體驗開始日期

        [JsonProperty("program_end_date")]
        public DateTime ProgramEndDate { get; set; }  //體驗結束日期
